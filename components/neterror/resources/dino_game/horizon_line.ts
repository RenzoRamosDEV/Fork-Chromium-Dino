...
// La línea del suelo está formada por DOS segmentos del mismo ancho que el canvas,
// colocados uno a continuación del otro. Al avanzar, el segmento que sale por
// la izquierda se recoloca a la derecha y se le asigna aleatoriamente una
// sección lisa o con baches del sprite (bumpThreshold controla la probabilidad).
export class HorizonLine {
  private canvasCtx: CanvasRenderingContext2D;
  // Posición X actual de cada uno de los dos segmentos.
  private xPos: [number, number];
  private yPos: number = 0;
  // Probabilidad (0-1) de que un segmento sea "bumpy" (con baches) en vez de liso.
  private bumpThreshold: number = 0.5;
  // Coordenada X dentro del sprite sheet de cada segmento (liso o con baches).
