...
// Lista de tipos de juego alternativos registrados en spriteDefinitionByType.
// Vacía en el build base; los parches de Chromium para eventos especiales (Navidad,
// cumpleaños, etc.) añaden entradas aquí junto con sus sprites y configuración.
export const GAME_TYPE: Array<keyof SpriteDefinitionByType> = [];

//******************************************************************************

// Caja de colisión rectangular (AABB). Almacena posición y tamaño en coordenadas
// relativas al origen del sprite correspondiente.
...
// Definición de un tipo de obstáculo. Los valores concretos están en spriteDefinitionByType.
// minGap: espacio mínimo en píxeles entre este obstáculo y el siguiente.
// multipleSpeed: velocidad mínima del juego para que puedan aparecer varios juntos.
// speedOffset: diferencia de velocidad respecto al horizonte (pterodáctilo vuela a distinta velocidad).
// minSpeed: velocidad mínima del juego para que este obstáculo aparezca.
...
// Mapa completo de todos los tipos de juego con sus coordenadas de sprite.
// "original" es el modo estándar. Los modos alternativos se añaden en tiempo de
// compilación por el sistema de parches de Chromium.
// ldpi = coordenadas para el sprite 1x (100%); hdpi = coordenadas para el sprite 2x (200%).
