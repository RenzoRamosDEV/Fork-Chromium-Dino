...
// Configuración global compartida por todos los BackgroundEl activos.
// Se sobreescribe al cambiar de modo de juego (enableAltGameMode en Horizon).
...
// Elemento de fondo genérico para modos de juego alternativos.
// Igual que Cloud pero con posición Y fija y soporte para animación por frames
// (fixed=true: alterna entre fixedYPos1 y fixedYPos2 a intervalo msPerFrame).
export class BackgroundEl {
  ...
  private type: string;
  // Acumulador de tiempo para la animación por frames.
  private animTimer: number = 0;
  private spriteConfig: BackgroundElSpriteConfig;
  // Alterna entre los dos frames de animación cuando fixed=true.
