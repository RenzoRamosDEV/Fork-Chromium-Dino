...
// Desplazamiento X de cada fase lunar dentro del sprite sheet.
// El sprite de la luna tiene 7 frames: luna llena (0) → luna nueva (140).
...
// Gestiona el modo noche: luna animada + estrellas.
// Se activa/desactiva gradualmente con un fade de opacidad (FADE_SPEED por frame).
// Cada vez que se activa se avanza una fase lunar (ciclo de 7 fases).
// Las estrellas se reposicionan aleatoriamente cuando la opacidad vuelve a 0.
export class NightMode {
  private spritePos: SpritePosition;
  private canvasCtx: CanvasRenderingContext2D;
  private xPos: number = 0;
  private yPos: number = 30;
  // Índice en el array PHASES, avanza cada ciclo día→noche.
  private currentPhase: number = 0;
  // 0 = invisible, 1 = totalmente visible. Se incrementa/decrementa con FADE_SPEED.
  private opacity: number = 0;
  private containerWidth: number;
  private stars: StarPosition[] = new Array(Config.NUM_STARS);
  // Se vuelve true tras el primer frame para evitar dibujar estrellas sin posición.
